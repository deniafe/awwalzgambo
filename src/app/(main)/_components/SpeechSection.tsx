...
export const Speech = () => {
    return (
      <section className="relative flex items-center justify-center py-[6rem] md:h-screen">
        <div className="max-w-4xl">
          ...
          /> */}
            ...
            <div className="p-4 border-t border-r border-solid border-black ">
                <Image src='/img/speech.Jpeg' height={500} width={500} alt={'awwalzgambo'} className="cols-span-1" />
            </div>
