...
export const About = () => {
  return (
    <section className="relative z-2 flex items-center justify-center py-[6rem] md:h-screen bg-gray-100">
      <div className="max-w-4xl px-4 md:px-0">
        <h2 className="text-3xl md:text-5xl text-center text-gray-400 font-bold mb-8">ABOUT</h2>
